            ...
            <ProjectSectionColumns centered className={styles.columns}>
              <div className={styles.imagesText}>
                ...
                <ProjectSectionText>
                  ...
                  apparente, aboutit à une absurdité, ou encore, une situation qui
                  contredit l'intuition commune, Le paradoxe de grand-père inclut
                  également dans cette liste, afin que nous puissions faire une définition
                  claire de la signification de cette théorie. Le paradoxe du grand-père
                  est un paradoxe logique évoqué, semble-t-il, la première fois par René
                  Barjavel dans son roman Le Voyageur imprudent. On l'invoque pour montrer
                  à quel point la possibilité d'un voyage dans le temps est problématique
                  pour des raisons indépendantes des lois de la nature. En effet, si des
                  voyages arbitraires dans le temps étaient possibles, on pourrait
                  remonter dans le passé pour tuer son grand-père.
                </ProjectSectionText>
                <ProjectSectionText>
                  <h5>Explication :</h5> Il déclare que si l'on remonte dans le temps
                  jusqu'à ce que leur grand-père ait engendré leur père et le tue, alors
                  le père ne naîtrait jamais, et le tueur non plus. Dans cette nouvelle
                  chronologie, le tueur n'existe jamais, il ne pourrait donc jamais
                  voyager dans le temps et assassiner son grand-père. Ainsi, le paradoxe
                  est créé. Dans ce qui peut être décrit comme une boucle temporelle, ce
                  cycle d'événements continuera à se répéter à l'infini entre deux points
                  fixes de la chronologie, ce que l'on appelle classiquement l'énigme "La
                  poule et l'œuf". L'exemple le plus notable de cet événement a été
                  lorsque SpongeGar a tué avec succès son propre père, Gar. Cependant,
                  c'était avant l'événement de la propre naissance de SpongeGar. Étant à
                  moitié primordial, SpongeGar a pu se libérer de la boucle et
                  réinitialiser la chronologie avant qu'elle ne s'effondre sur elle-même.
                </ProjectSectionText>
              </div>
              <div>
                <Image
            ...
            <ProjectSectionContent>
              <ProjectTextRow>
                ...
                <ProjectSectionText>
                  ...
                  pourraient enfin explorer en dehors de notre système solaire. En 1947,
                  les humains ont d'abord dépassé la vitesse (beaucoup plus lente) du son,
                  ...
                  atteignait la vitesse de la lumière, sa masse deviendrait infinie. Et
                  par conséquent, l'énergie nécessaire pour déplacer l'objet deviendrait
          ...
          <ProjectSection>
            <ProjectSectionColumns centered className={styles.columns}>
              <div className={styles.imagesText}>
                ...
                <ProjectSectionText>
                  le mystere de l’avion du vol 513 qui a atterri 37 ans après avoir
                  décollé Mystère du vol 513 de Santiago qui a «disparu» en 1954, qui a
                  atterri 37 ans après avoir décollé9 avec des squelettes .
                </ProjectSectionText>
              </div>
              <div>
                <Image
            ...
            <ProjectSectionColumns centered className={styles.columns}>
              ...
              <div className={styles.imagesText}>
                ...
                <ProjectSectionText>
                  ...
                  de soleil étaient modernes et non des styles portés dans les années
                  1940.
                </ProjectSectionText>
              </div>
            </ProjectSectionColumns>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      ...
                      <ProjectSectionText>
                        C’est le moyen le plus simple et le plus pratique de voyager dans
                        le futur lointain. Ceci est t’expliquer dans la théorie
                        d’einstein.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="start" width="s">
                      ...
                      <ProjectSectionText>
                        C’est aussi inspirée pas einstein Selon sa théorie de la
                        relativité générale, plus la gravité que vous ressentez est forte,
                        plus le temps se déplace lentement.À mesure que vous vous
                        rapprochez du centre de la Terre, par exemple, la force de gravité
                        augmente. Le temps passe plus lentement pour vos pieds que pour
                        votre tête.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      ...
                      <ProjectSectionText>
                        La relativité générale permet également la possibilité de
                        raccourcis à travers l'espace-temps, connus sous le nom de trous
                        de ver, qui pourraient être capables de franchir des distances
                        d'un milliard d'années-lumière ou plus, ou à différents moments
                        dans le temps
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
